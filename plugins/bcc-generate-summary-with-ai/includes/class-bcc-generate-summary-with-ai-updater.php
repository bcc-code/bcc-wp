...
class BCC_Generate_Summary_With_AI_Updater {
	...
	public function info( $res, $action, $args ) {
		...
		$res->author_profile = "https://github.com/bcc-code";
		$res->download_link  = "https://github.com/bcc-code/bcc-wp/releases/download/" . $this->plugin_slug . "-v" . $remote->version . "/" . $this->plugin_slug . ".zip";
	...
	public function update( $transient ) {
		...
		$res->tested      = null;
		$res->package     = "https://github.com/bcc-code/bcc-wp/releases/download/" . $this->plugin_slug . "-v" . $this->version . "/" . $this->plugin_slug . ".zip";
		...
		if (
			...
			$res->tested      = $remote->tested;
			$res->package     = "https://github.com/bcc-code/bcc-wp/releases/download/" . $this->plugin_slug . "-v" . $remote->version . "/" . $this->plugin_slug . ".zip";
