...
2. Search for **Kinsta SSH** in LastPass and open it.
    ...
    2. Create a file on your local, name it **kinsta** and save it in a safe place (best is in the C:\Users\[YourUser]\.ssh folder) and give it permission access (e.g. `chmod 400 kinsta`).<br>
